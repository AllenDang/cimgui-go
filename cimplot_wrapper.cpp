...
void Plot_SetNextErrorBarStyle() { Plot_SetNextErrorBarStyleV((ImVec4){.x=0, .y=0, .z=0, .w=0},-1,-1); }
...
void Plot_SetNextMarkerStyle() { Plot_SetNextMarkerStyleV(-1,-1,(ImVec4){.x=0, .y=0, .z=0, .w=0},-1,(ImVec4){.x=0, .y=0, .z=0, .w=0}); }
...
void Plot_SetNextLineStyle() { Plot_SetNextLineStyleV((ImVec4){.x=0, .y=0, .z=0, .w=0},-1); }
...
void Plot_SetNextFillStyle() { Plot_SetNextFillStyleV((ImVec4){.x=0, .y=0, .z=0, .w=0},-1); }
bool Plot_BeginPlot(const char* title_id) { return Plot_BeginPlotV(title_id,(ImVec2){.x=0, .y=0},0); }
...
void Plot_PlotImage(const char* label_id,ImTextureID user_texture_id,const ImPlotPoint bounds_min,const ImPlotPoint bounds_max) { Plot_PlotImageV(label_id,user_texture_id,bounds_min,bounds_max,(ImVec2){.x=0, .y=0},(ImVec2){.x=0, .y=0},(ImVec4){.x=0, .y=0, .z=0, .w=0},0); }
