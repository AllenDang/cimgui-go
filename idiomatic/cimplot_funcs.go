...
// flags: 0
func PlotBeginDragDropSourceAxisV(axis AxisName, flags DragDropFlags) bool {
...
func PlotBeginDragDropTargetAxis(axis AxisName) bool {
...
// x_axis: -1
// y_axis: -1
func PlotGetPlotMousePosV(x_axis AxisName, y_axis AxisName) PlotPoint {
	pOut := &PlotPoint{}
	pOutArg, pOutFin := wrap[C.ImPlotPoint, *PlotPoint](pOut)
	defer pOutFin()
...
func PlotIsAxisHovered(axis AxisName) bool {
...
// x_axis: -1
// y_axis: -1
func PlotPixelsToPlotFloatV(x float32, y float32, x_axis AxisName, y_axis AxisName) PlotPoint {
	pOut := &PlotPoint{}
	pOutArg, pOutFin := wrap[C.ImPlotPoint, *PlotPoint](pOut)
	defer pOutFin()
...
// x_axis: -1
// y_axis: -1
func PlotPixelsToPlotVec2V(pix Vec2, x_axis AxisName, y_axis AxisName) PlotPoint {
	pOut := &PlotPoint{}
	pOutArg, pOutFin := wrap[C.ImPlotPoint, *PlotPoint](pOut)
	defer pOutFin()
...
// x_axis: -1
// y_axis: -1
func PlotPlotToPixelsPlotPoIntV(plt PlotPoint, x_axis AxisName, y_axis AxisName) Vec2 {
	pOut := &Vec2{}
	pOutArg, pOutFin := wrap[C.ImVec2, *Vec2](pOut)
	defer pOutFin()
...
// x_axis: -1
// y_axis: -1
func PlotPlotToPixelsdoubleV(x float64, y float64, x_axis AxisName, y_axis AxisName) Vec2 {
	pOut := &Vec2{}
	pOutArg, pOutFin := wrap[C.ImVec2, *Vec2](pOut)
	defer pOutFin()
...
func PlotSetAxes(x_axis AxisName, y_axis AxisName) {
	C.Plot_SetAxes(C.ImAxis(x_axis), C.ImAxis(y_axis))
}

func PlotSetAxis(axis AxisName) {
...
// cond: ImPlotCond_Once
func PlotSetNextAxisLimitsV(axis AxisName, v_min float64, v_max float64, cond PlotCond) {
	C.Plot_SetNextAxisLimitsV(C.ImAxis(axis), C.double(v_min), C.double(v_max), C.ImPlotCond(cond))
}

func PlotSetNextAxisLinks(axis AxisName, link_min *float64, link_max *float64) {
...
func PlotSetNextAxisToFit(axis AxisName) {
...
// flags: 0
// label: ((void*)0)
func PlotSetupAxisV(axis AxisName, label string, flags PlotAxisFlags) {
	labelArg, labelFin := wrapString(label)
	defer labelFin()
...
func PlotSetupAxisFormatStr(axis AxisName, fmt string) {
	fmtArg, fmtFin := wrapString(fmt)
	defer fmtFin()
...
// cond: ImPlotCond_Once
func PlotSetupAxisLimitsV(axis AxisName, v_min float64, v_max float64, cond PlotCond) {
	C.Plot_SetupAxisLimitsV(C.ImAxis(axis), C.double(v_min), C.double(v_max), C.ImPlotCond(cond))
}

func PlotSetupAxisLimitsConstraints(axis AxisName, v_min float64, v_max float64) {
	C.Plot_SetupAxisLimitsConstraints(C.ImAxis(axis), C.double(v_min), C.double(v_max))
}

func PlotSetupAxisLinks(axis AxisName, link_min *float64, link_max *float64) {
	link_minArg, link_minFin := wrapNumberPtr[C.double, float64](link_min)
	defer link_minFin()
...
func PlotSetupAxisScalePlotScale(axis AxisName, scale PlotScale) {
...
// keep_default: false
// labels: ((void*)0)
func PlotSetupAxisTicksdoubleV(axis AxisName, v_min float64, v_max float64, n_ticks int32, labels []string, keep_default bool) {
...
func PlotSetupAxisZoomConstraints(axis AxisName, z_min float64, z_max float64) {
...
func PlotBeginDragDropSourceAxis(axis AxisName) bool {
...
func PlotSetNextAxisLimits(axis AxisName, v_min float64, v_max float64) {
...
func PlotSetupAxis(axis AxisName) {
	C.Plot_SetupAxis(C.ImAxis(axis))
}

func PlotSetupAxisLimits(axis AxisName, v_min float64, v_max float64) {
	C.Plot_SetupAxisLimits(C.ImAxis(axis), C.double(v_min), C.double(v_max))
}

func PlotSetupAxisTicksdouble(axis AxisName, v_min float64, v_max float64, n_ticks int32) {
...
func (self PlotAxis) ID() ID {
	return ID(C.ImPlotAxis_GetID(self.handle()))
}
...
func (self PlotContext) CurrentStyle() PlotStyle {
...
func (self PlotInputMap) PanMod() ModFlags {
...
func (self PlotInputMap) SelectMod() ModFlags {
...
func (self PlotInputMap) SelectHorzMod() ModFlags {
...
func (self PlotInputMap) SelectVertMod() ModFlags {
...
func (self PlotInputMap) OverrideMod() ModFlags {
...
func (self PlotInputMap) ZoomMod() ModFlags {
...
func (self PlotItem) ID() ID {
	return ID(C.ImPlotItem_GetID(self.handle()))
}
...
func (self PlotItemGroup) ID() ID {
	return ID(C.ImPlotItemGroup_GetID(self.handle()))
}
...
func (self PlotPlot) ID() ID {
	return ID(C.ImPlotPlot_GetID(self.handle()))
}
...
func (self *PlotPlot) SetCurrentX(v AxisName) {
	C.ImPlotPlot_SetCurrentX(self.handle(), C.ImAxis(v))
}

func (self PlotPlot) CurrentX() AxisName {
	return AxisName(C.ImPlotPlot_GetCurrentX(self.handle()))
}

func (self *PlotPlot) SetCurrentY(v AxisName) {
	C.ImPlotPlot_SetCurrentY(self.handle(), C.ImAxis(v))
}

func (self PlotPlot) CurrentY() AxisName {
	return AxisName(C.ImPlotPlot_GetCurrentY(self.handle()))
}
...
func (self PlotSubplot) ID() ID {
	return ID(C.ImPlotSubplot_GetID(self.handle()))
}
...
func (self *PlotTag) SetAxis(v AxisName) {
	C.ImPlotTag_SetAxis(self.handle(), C.ImAxis(v))
}

func (self PlotTag) Axis() AxisName {
	return AxisName(C.ImPlotTag_GetAxis(self.handle()))
}
