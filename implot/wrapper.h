...
extern void wrap_ImPlotAnnotationCollection_Append(ImPlotAnnotationCollection* self,const ImVec2_c pos,const ImVec2_c off,ImU32 bg,ImU32 fg,bool clamp,const char* fmt);
...
extern void wrap_ImPlot_AddTextCenteredV(ImDrawList* DrawList,ImVec2_c top_center,ImU32 col,const char* text_begin);
extern void wrap_ImPlot_AddTextVerticalV(ImDrawList* DrawList,ImVec2_c pos,ImU32 col,const char* text_begin);
extern void wrap_ImPlot_Annotation_Str(double x,double y,const ImVec4_c col,const ImVec2_c pix_offset,bool clamp,const char* fmt);
...
extern void wrap_ImPlot_Locator_Default(ImPlotTicker* ticker,const ImPlotRange_c range,float pixels,bool vertical,ImPlotFormatter formatter,uintptr_t formatter_data);
extern void wrap_ImPlot_Locator_Log10(ImPlotTicker* ticker,const ImPlotRange_c range,float pixels,bool vertical,ImPlotFormatter formatter,uintptr_t formatter_data);
extern void wrap_ImPlot_Locator_SymLog(ImPlotTicker* ticker,const ImPlotRange_c range,float pixels,bool vertical,ImPlotFormatter formatter,uintptr_t formatter_data);
extern void wrap_ImPlot_Locator_Time(ImPlotTicker* ticker,const ImPlotRange_c range,float pixels,bool vertical,ImPlotFormatter formatter,uintptr_t formatter_data);
extern void wrap_ImPlot_PlotBarsGV(const char* label_id,ImPlotGetter getter,uintptr_t data,int count,double bar_size,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotBarsG_LJV(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count,double bar_size,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotDigitalGV(const char* label_id,ImPlotGetter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotDigitalG_LJV(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotLineGV(const char* label_id,ImPlotGetter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotLineG_LJV(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_FloatPtrPlotFormatterV(const char* const label_ids[],const float* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_S16PtrPlotFormatterV(const char* const label_ids[],const ImS16* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_S32PtrPlotFormatterV(const char* const label_ids[],const ImS32* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_S64PtrPlotFormatterV(const char* const label_ids[],const ImS64* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_S8PtrPlotFormatterV(const char* const label_ids[],const ImS8* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_U16PtrPlotFormatterV(const char* const label_ids[],const ImU16* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_U32PtrPlotFormatterV(const char* const label_ids[],const ImU32* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_U64PtrPlotFormatterV(const char* const label_ids[],const ImU64* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_U8PtrPlotFormatterV(const char* const label_ids[],const ImU8* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotPieChart_doublePtrPlotFormatterV(const char* const label_ids[],const double* values,int count,double x,double y,double radius,ImPlotFormatter fmt,uintptr_t fmt_data,double angle0,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotScatterGV(const char* label_id,ImPlotGetter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotScatterG_LJV(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotShadedGV(const char* label_id,ImPlotGetter getter1,uintptr_t data1,ImPlotGetter getter2,uintptr_t data2,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotShadedG_LJV(const char* label_id,ImPlotPoint_getter getter1,uintptr_t data1,ImPlotPoint_getter getter2,uintptr_t data2,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotStairsGV(const char* label_id,ImPlotGetter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
extern void wrap_ImPlot_PlotStairsG_LJV(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count,const ImPlotSpec_c spec);
...
extern void wrap_ImPlot_TagX_Str(double x,const ImVec4_c col,const char* fmt);
extern void wrap_ImPlot_TagY_Str(double y,const ImVec4_c col,const char* fmt);
...
extern ImVec4_c wrap_ImPlot_GetColormapColor(int idx);
extern int wrap_ImPlot_GetColormapSize();
extern ImVec2_c wrap_ImPlot_GetLocationPos(const ImRect outer_rect,const ImVec2 inner_size,ImPlotLocation location);
extern ImPlotRect_c wrap_ImPlot_GetPlotLimits();
extern ImPlotPoint_c wrap_ImPlot_GetPlotMousePos();
extern ImPlotRect_c wrap_ImPlot_GetPlotSelection();
...
extern ImPlotTime_c wrap_ImPlot_MakeTime(int year);
extern void wrap_ImPlot_MapInputDefault();
extern void wrap_ImPlot_MapInputReverse();
extern ImPlotPoint_c wrap_ImPlot_PixelsToPlot_Float(float x,float y);
extern ImPlotPoint_c wrap_ImPlot_PixelsToPlot_Vec2(const ImVec2 pix);
...
extern void wrap_ImPlot_PlotBarsG(const char* label_id,ImPlotGetter getter,uintptr_t data,int count,double bar_size);
extern void wrap_ImPlot_PlotBarsG_LJ(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count,double bar_size);
...
extern void wrap_ImPlot_PlotBubbles_FloatPtrFloatPtrFloatPtr(const char* label_id,const float* xs,const float* ys,const float* szs,int count);
extern void wrap_ImPlot_PlotBubbles_FloatPtrFloatPtrInt(const char* label_id,const float* values,const float* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S16PtrS16PtrInt(const char* label_id,const ImS16* values,const ImS16* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S16PtrS16PtrS16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,const ImS16* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S32PtrS32PtrInt(const char* label_id,const ImS32* values,const ImS32* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S32PtrS32PtrS32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,const ImS32* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S64PtrS64PtrInt(const char* label_id,const ImS64* values,const ImS64* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S64PtrS64PtrS64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,const ImS64* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S8PtrS8PtrInt(const char* label_id,const ImS8* values,const ImS8* szs,int count);
extern void wrap_ImPlot_PlotBubbles_S8PtrS8PtrS8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,const ImS8* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U16PtrU16PtrInt(const char* label_id,const ImU16* values,const ImU16* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U16PtrU16PtrU16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,const ImU16* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U32PtrU32PtrInt(const char* label_id,const ImU32* values,const ImU32* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U32PtrU32PtrU32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,const ImU32* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U64PtrU64PtrInt(const char* label_id,const ImU64* values,const ImU64* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U64PtrU64PtrU64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,const ImU64* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U8PtrU8PtrInt(const char* label_id,const ImU8* values,const ImU8* szs,int count);
extern void wrap_ImPlot_PlotBubbles_U8PtrU8PtrU8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,const ImU8* szs,int count);
extern void wrap_ImPlot_PlotBubbles_doublePtrdoublePtrInt(const char* label_id,const double* values,const double* szs,int count);
extern void wrap_ImPlot_PlotBubbles_doublePtrdoublePtrdoublePtr(const char* label_id,const double* xs,const double* ys,const double* szs,int count);
extern void wrap_ImPlot_PlotDigitalG(const char* label_id,ImPlotGetter getter,uintptr_t data,int count);
extern void wrap_ImPlot_PlotDigitalG_LJ(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count);
...
extern void wrap_ImPlot_PlotLineG(const char* label_id,ImPlotGetter getter,uintptr_t data,int count);
extern void wrap_ImPlot_PlotLineG_LJ(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count);
...
extern void wrap_ImPlot_PlotPolygon_FloatPtr(const char* label_id,const float* xs,const float* ys,int count);
extern void wrap_ImPlot_PlotPolygon_S16Ptr(const char* label_id,const ImS16* xs,const ImS16* ys,int count);
extern void wrap_ImPlot_PlotPolygon_S32Ptr(const char* label_id,const ImS32* xs,const ImS32* ys,int count);
extern void wrap_ImPlot_PlotPolygon_S64Ptr(const char* label_id,const ImS64* xs,const ImS64* ys,int count);
extern void wrap_ImPlot_PlotPolygon_S8Ptr(const char* label_id,const ImS8* xs,const ImS8* ys,int count);
extern void wrap_ImPlot_PlotPolygon_U16Ptr(const char* label_id,const ImU16* xs,const ImU16* ys,int count);
extern void wrap_ImPlot_PlotPolygon_U32Ptr(const char* label_id,const ImU32* xs,const ImU32* ys,int count);
extern void wrap_ImPlot_PlotPolygon_U64Ptr(const char* label_id,const ImU64* xs,const ImU64* ys,int count);
extern void wrap_ImPlot_PlotPolygon_U8Ptr(const char* label_id,const ImU8* xs,const ImU8* ys,int count);
extern void wrap_ImPlot_PlotPolygon_doublePtr(const char* label_id,const double* xs,const double* ys,int count);
extern void wrap_ImPlot_PlotScatterG(const char* label_id,ImPlotGetter getter,uintptr_t data,int count);
extern void wrap_ImPlot_PlotScatterG_LJ(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count);
...
extern void wrap_ImPlot_PlotShadedG(const char* label_id,ImPlotGetter getter1,uintptr_t data1,ImPlotGetter getter2,uintptr_t data2,int count);
extern void wrap_ImPlot_PlotShadedG_LJ(const char* label_id,ImPlotPoint_getter getter1,uintptr_t data1,ImPlotPoint_getter getter2,uintptr_t data2,int count);
...
extern void wrap_ImPlot_PlotStairsG(const char* label_id,ImPlotGetter getter,uintptr_t data,int count);
extern void wrap_ImPlot_PlotStairsG_LJ(const char* label_id,ImPlotPoint_getter getter,uintptr_t data,int count);
...
extern ImVec2_c wrap_ImPlot_PlotToPixels_PlotPoint(const ImPlotPoint plt);
extern ImVec2_c wrap_ImPlot_PlotToPixels_double(double x,double y);
...
extern ImVec4_c wrap_ImPlot_SampleColormap(float t);
