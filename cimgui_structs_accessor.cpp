...
void ImGuiInputEvent_SetIgnoredAsSame(ImGuiInputEvent *ImGuiInputEventPtr, bool v) { ImGuiInputEventPtr->IgnoredAsSame = v; }
bool ImGuiInputEvent_GetIgnoredAsSame(ImGuiInputEvent *self) { return self->IgnoredAsSame; }
