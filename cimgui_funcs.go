...
// FontAtlas_GetTexDataAsRGBA32V parameter default value hint:
// out_bytes_per_pixel: NULL
func (self ImFontAtlas) GetTexDataAsRGBA32V(out_pixels *C.uchar, out_width *int32, out_height *int32, out_bytes_per_pixel *int32) {
	...
	C.FontAtlas_GetTexDataAsRGBA32V(self.handle(), &out_pixels, out_widthArg, out_heightArg, out_bytes_per_pixelArg)
}
...
// FontAtlas_GetTexDataAsAlpha8V parameter default value hint:
// out_bytes_per_pixel: NULL
func (self ImFontAtlas) GetTexDataAsAlpha8V(out_pixels *C.uchar, out_width *int32, out_height *int32, out_bytes_per_pixel *int32) {
	out_widthArg, out_widthFin := wrapInt32(out_width)
	defer out_widthFin()
	...
	C.FontAtlas_GetTexDataAsAlpha8V(self.handle(), &out_pixels, out_widthArg, out_heightArg, out_bytes_per_pixelArg)
}
...
func InputText(label string, buf string, buf_size uint64) bool {
	labelArg, labelFin := wrapString(label)
	defer labelFin()
	...
	return C.InputText(labelArg, bufArg, C.xlong(buf_size)) == C.bool(true)
}
...
func (self ImFontAtlas) GetTexDataAsRGBA32(out_pixels *C.uchar, out_width *int32, out_height *int32) {
	out_widthArg, out_widthFin := wrapInt32(out_width)
	defer out_widthFin()
	...
	C.FontAtlas_GetTexDataAsRGBA32(self.handle(), &out_pixels, out_widthArg, out_heightArg)
}
...
func (self ImFontAtlas) GetTexDataAsAlpha8(out_pixels *C.uchar, out_width *int32, out_height *int32) {
	out_widthArg, out_widthFin := wrapInt32(out_width)
	defer out_widthFin()
	...
	C.FontAtlas_GetTexDataAsAlpha8(self.handle(), &out_pixels, out_widthArg, out_heightArg)
}
