...
extern void wrap_ImDrawList_AddText_FontPtrV(ImDrawList* self,ImFont* font,float font_size,const ImVec2_c pos,ImU32 col,const char* text_begin,float wrap_width,const ImVec4* cpu_fine_clip_rect);
extern void wrap_ImDrawList_AddText_Vec2V(ImDrawList* self,const ImVec2_c pos,ImU32 col,const char* text_begin);
...
extern ImVec2_c wrap_ImFont_CalcTextSizeAV(ImFont* self,float size,float max_width,float wrap_width,const char* text_begin,const char** out_remaining);
...
extern void wrap_ImFont_RenderTextV(ImFont* self,ImDrawList* draw_list,float size,const ImVec2_c pos,ImU32 col,const ImVec4_c clip_rect,const char* text_begin,float wrap_width,ImDrawTextFlags flags);
...
extern ImVec2_c wrap_igCalcTextSizeV(const char* text,const int text_len,bool hide_text_after_double_hash,float wrap_width);
...
extern ImVec2_c wrap_igImFontCalcTextSizeEx(ImFont* font,float size,float max_width,float wrap_width,const char* text_begin,const char* text_end_display,const char** out_remaining,ImVec2_c* out_offset,ImDrawTextFlags flags);
...
extern bool wrap_igInputTextExV(const char* label,const char* hint,char* buf,int buf_size,const ImVec2_c size_arg,ImGuiInputTextFlags flags,ImGuiInputTextCallback callback,uintptr_t user_data);
extern bool wrap_igInputTextMultilineV(const char* label,char* buf,size_t buf_size,const ImVec2_c size,ImGuiInputTextFlags flags,ImGuiInputTextCallback callback,uintptr_t user_data);
...
extern void wrap_igLogRenderedTextV(const ImVec2_c* ref_pos,const char* text,const int text_len);
...
extern int wrap_igPlotEx(ImGuiPlotType plot_type,const char* label,float(*values_getter)(void* data,int idx),uintptr_t data,int values_count,int values_offset,const char* overlay_text,float scale_min,float scale_max,const ImVec2_c size_arg);
extern void wrap_igPlotHistogram_FnFloatPtr(const char* label,float(*values_getter)(void* data,int idx),uintptr_t data,int values_count,int values_offset,const char* overlay_text,float scale_min,float scale_max,ImVec2_c graph_size);
extern void wrap_igPlotLines_FnFloatPtr(const char* label,float(*values_getter)(void* data,int idx),uintptr_t data,int values_count,int values_offset,const char* overlay_text,float scale_min,float scale_max,ImVec2_c graph_size);
...
extern void wrap_igRenderTextV(ImVec2_c pos,const char* text,const int text_len,bool hide_text_after_hash);
extern void wrap_igRenderTextClippedV(const ImVec2_c pos_min,const ImVec2_c pos_max,const char* text,const int text_len,const ImVec2_c* text_size_if_known,const ImVec2_c align,const ImRect* clip_rect);
extern void wrap_igRenderTextClippedExV(ImDrawList* draw_list,const ImVec2_c pos_min,const ImVec2_c pos_max,const char* text,const int text_len,const ImVec2_c* text_size_if_known,const ImVec2_c align,const ImRect* clip_rect);
extern void wrap_igRenderTextEllipsis(ImDrawList* draw_list,const ImVec2_c pos_min,const ImVec2_c pos_max,float ellipsis_max_x,const char* text,const int text_len,const ImVec2_c* text_size_if_known);
extern void wrap_igRenderTextWrapped(ImVec2_c pos,const char* text,const int text_len,float wrap_width);
...
extern void wrap_igSetNextWindowSizeConstraintsV(const ImVec2_c size_min,const ImVec2_c size_max,ImGuiSizeCallback custom_callback,uintptr_t custom_callback_data);
extern void wrap_igSetTooltip(const char* fmt);
extern bool wrap_igSliderBehavior(const ImRect_c bb,ImGuiID id,ImGuiDataType data_type,uintptr_t p_v,const uintptr_t p_min,const uintptr_t p_max,const char* format,ImGuiSliderFlags flags,ImRect* out_grab_bb);
...
extern bool wrap_igVSliderScalarV(const char* label,const ImVec2_c size,ImGuiDataType data_type,uintptr_t p_data,const uintptr_t p_min,const uintptr_t p_max,const char* format,ImGuiSliderFlags flags);
extern ImColor_c wrap_ImColor_HSV(float h,float s,float v);
...
extern void wrap_ImDrawList_AddCallback(ImDrawList* self,ImDrawCallback callback);
...
extern void wrap_ImDrawList_AddLineH(ImDrawList* self,float min_x,float max_x,float y,ImU32 col);
extern void wrap_ImDrawList_AddLineV(ImDrawList* self,float x,float min_y,float max_y,ImU32 col);
extern void wrap_ImDrawList_AddNgon(ImDrawList* self,const ImVec2 center,float radius,ImU32 col,int num_segments);
extern void wrap_ImDrawList_AddPolyline(ImDrawList* self,const ImVec2* points,int num_points,ImU32 col,float thickness);
...
extern ImFont* wrap_ImFontAtlas_AddFontDefaultBitmap(ImFontAtlas* self);
extern ImFont* wrap_ImFontAtlas_AddFontDefaultVector(ImFontAtlas* self);
...
extern ImVec2_c wrap_ImFont_CalcTextSizeA(ImFont* self,float size,float max_width,float wrap_width,const char* text_begin);
...
extern ImVec2_c wrap_igCalcTextSize(const char* text,const int text_len);
...
extern ImVec2_c wrap_igGetMouseDragDelta();
...
extern ImVec2_c wrap_igScrollToRectEx(ImGuiWindow* window,const ImRect rect);
