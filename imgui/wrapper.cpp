...
void wrap_ImGuiFreeType_SetAllocatorFunctions(void*(*alloc_func)(size_t sz,void* user_data),void(*free_func)(void* ptr,void* user_data),uintptr_t user_data) { ImGuiFreeType_SetAllocatorFunctions(alloc_func,free_func,(void*)(uintptr_t)user_data); }
