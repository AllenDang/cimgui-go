...
void wrap_igImFontCalcTextSizeEx(ImVec2 *pOut,ImFont* font,float size,float max_width,float wrap_width,const char* text_begindisplay,const int text_len,const char** out_remaining,ImVec2* out_offset,ImDrawTextFlags flags) { igImFontCalcTextSizeEx(pOut,font,size,max_width,wrap_width,text_begin,text_end_display,0,out_remaining,out_offset,flags); }
