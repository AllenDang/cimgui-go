...
typedef unsigned int ImWchar32;typedef ImWchar32 ImWchar;
...
{    ImGuiConfigFlags ConfigFlags;
    ...
    void (*SetPlatformImeDataFn)(ImGuiViewport* viewport, ImGuiPlatformImeData* data);    void* _UnusedPadding;
